...
/** URL-param review for `pain-details` and other legacy links (outside wizard context). */
export default function ReviewLegacyScreen() {
  ...
  const handleGetAnalysis = async () => {
    ...
    try {
      ...
      if (!result.ok) {
        throw new Error(`Failed to submit assessment: ${result.status}`);
      }
        ...
        <View style={styles.readyCard}>
          ...
          <View>
            ...
            <Text style={styles.readySubtitle}>
              Our AI will analyze your symptoms and create a personalized recovery plan
            </Text>
          </View>
        </View>
      </ScrollView>
